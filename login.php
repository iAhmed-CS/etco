...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: rgb(80, 0, 126);">
        ...
        <ul class="navbar-nav sticky-top mr-auto" style="background-color: #12043e;">
            ...
            <li class="nav-item"><a class="nav-link" href="signUp.php"><i class="fa fa-fw fa-user"></i>Sign Up</a></li>
        </ul>
        <!-- Search -->
    ...
    <br />
    <br />
    <h2 style="text-align: center; font-family: 'Times New Roman', Times, serif; color: white"><strong>Login an Existing Account</strong></h2>
        <div class="login">
            <form action="" method="POST">
                ...
                <input type="submit" value="Login" class="btnSubmit"><br />
                <a href="#.html" style="text-decoration: underline;">Forgot Password?</a>
            </form>
        </div>
        <br />
        <div>
            <h6 style="text-align: center; color: white">Create a New Account?</h6>
            <a href="signUp.php"><input type="submit" value="Sign-Up" class="btnSubmit2"></a>
        </div>
    </div>
    <!-------------------- Footer -------------------->
    <br />
